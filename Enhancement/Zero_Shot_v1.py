...
def main():
    ...
    input_dir = 'data/sewer_samples'
    out_dir = 'results/sewer_results_Syn'
    os.makedirs(out_dir, exist_ok=True)
    
    # Use the pre-trained LOLv2 config and weights
    opt_path = 'Options/Multinex_LOL-v2-syn.yaml'
    weights_path = 'pretrained_weights/Multinex_LOL-v2-syn.pth'
    
    # 2. Initialize Model
    print("Loading Multinex Model...")
